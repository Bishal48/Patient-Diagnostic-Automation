...
using namespace std;
class Admin{    //Stub to manage a Admin
public:
    void lock(){cout<<"Admin acquired the lock"<<endl;}
    void unlock(){cout<<"Admin released the lock"<<endl;}
};
...
private:
    ...
    static Admin admin;//symbolic Admin
public:
...
Admin radiologyDepartment::admin;
